USE [master]
GO
/****** Object:  Database [BSDB2]    Script Date: 11/1/2025 11:25:55 PM ******/
CREATE DATABASE [BSDB2]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'BSDB2', FILENAME = N'C:\Users\Andyy\Downloads\DoAnCNPM\CNPM\DataBase\BSDB2.mdf' , SIZE = 3264KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'BSDB2_log', FILENAME = N'C:\Users\Andyy\Downloads\DoAnCNPM\CNPM\DataBase\BSDB2_log.ldf' , SIZE = 832KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
...
USE [BSDB2]
GO
/****** Object:  Table [dbo].[Admin]    Script Date: 11/1/2025 11:25:55 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[ChiTietDDH]    Script Date: 11/1/2025 11:25:55 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DonDatHang]    Script Date: 11/1/2025 11:25:55 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[KhachHang]    Script Date: 11/1/2025 11:25:55 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[LienHe]    Script Date: 11/1/2025 11:25:55 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[NhaXuatBan]    Script Date: 11/1/2025 11:25:55 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[Sach]    Script Date: 11/1/2025 11:25:55 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[TacGia]    Script Date: 11/1/2025 11:25:55 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TheLoai]    Script Date: 11/1/2025 11:25:55 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
INSERT [dbo].[Admin] ([IDAdmin], [TaiKhoan], [MatKhau], [HoTen], [TrangThai]) VALUES (1, N'admin', N'admin', N'Duy', 1)
INSERT [dbo].[Admin] ([IDAdmin], [TaiKhoan], [MatKhau], [HoTen], [TrangThai]) VALUES (3, N'vhp', N'123456', N'VHP', 1)
...
INSERT [dbo].[DonDatHang] ([MaDDH], [NgayDat], [NgayGiao], [TinhTrang], [MaKH]) VALUES (1, CAST(N'2025-07-05 13:22:00' AS SmallDateTime), CAST(N'2025-07-08 13:22:00' AS SmallDateTime), 1, 1)
INSERT [dbo].[DonDatHang] ([MaDDH], [NgayDat], [NgayGiao], [TinhTrang], [MaKH]) VALUES (2, CAST(N'2025-07-05 13:24:00' AS SmallDateTime), CAST(N'2025-07-08 13:24:00' AS SmallDateTime), 1, 1)
SET IDENTITY_INSERT [dbo].[DonDatHang] OFF
SET IDENTITY_INSERT [dbo].[KhachHang] ON 

INSERT [dbo].[KhachHang] ([MaKH], [TenKH], [Email], [DiaChi], [DienThoai], [NgaySinh], [TaiKhoan], [MatKhau], [NgayTao], [TrangThai]) VALUES (1, N'test1', N'test1@gmail.com', N'hcm', N'123456', CAST(N'1995-11-05 00:00:00' AS SmallDateTime), N'test', N'123', CAST(N'2025-07-01 11:14:10.630' AS DateTime), 1)
INSERT [dbo].[KhachHang] ([MaKH], [TenKH], [Email], [DiaChi], [DienThoai], [NgaySinh], [TaiKhoan], [MatKhau], [NgayTao], [TrangThai]) VALUES (7, N'admin', N'emty@gmail.com', N'TP.HCM', N'123456789', CAST(N'2025-10-04 00:00:00' AS SmallDateTime), N'admin', N'123456', CAST(N'2025-10-28 22:41:31.740' AS DateTime), 1)
INSERT [dbo].[KhachHang] ([MaKH], [TenKH], [Email], [DiaChi], [DienThoai], [NgaySinh], [TaiKhoan], [MatKhau], [NgayTao], [TrangThai]) VALUES (10, N'P', N'test2@gmail.com', N'TP.HCM', N'123456', CAST(N'2025-06-05 00:00:00' AS SmallDateTime), N'test2', N'123456', CAST(N'2025-10-28 22:49:00.000' AS DateTime), 1)
SET IDENTITY_INSERT [dbo].[KhachHang] OFF
SET IDENTITY_INSERT [dbo].[LienHe] ON 

INSERT [dbo].[LienHe] ([MaLH], [Ho], [Ten], [Email], [DienThoai], [NoiDung], [NgayCapNhat]) VALUES (2, N'a', N'a', N'a@gmail.com', N'123456', N'đây là nội dung thứ 2', CAST(N'2025-07-01 00:00:00' AS SmallDateTime))
INSERT [dbo].[LienHe] ([MaLH], [Ho], [Ten], [Email], [DienThoai], [NoiDung], [NgayCapNhat]) VALUES (3, N'b', N'b', N'test@gmail.com', N'1', N'nội dung 3', CAST(N'2025-07-01 00:00:00' AS SmallDateTime))
